...
wash2_conf_df = wash2_df[wash2_df['group_by']=='Race/Ethnicity'][['school_year','group_by_value','student_count']].pivot(index='school_year', columns='group_by_value', values='student_count')

wash2_conf_df.rename(columns={c:c.lower().replace(' ','_') for c in wash2_conf_df.columns}, inplace=True)
...
wash1_conf_df = wash1_df[['year','school_name', 'black_count', 'amer_indian_count', 'asian_count','hisp_count','pac_isle_count','white_count','two_or_more_count' ]]
